...
TEST(LinearAlgebraTests, CosineSimilarityBlas) {
  std::vector<std::vector<double>> matrix_a = {{1.0, 0.0}, {1.0, 0.0}};
  std::vector<std::vector<double>> matrix_b = {{1.0, 0.0}, {0.0, 1.0}};
  auto result = LinearAlgebra::cosineBlas(matrix_a, matrix_b);
